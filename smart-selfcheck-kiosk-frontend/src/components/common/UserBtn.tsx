...
export const UserBtn = () => {
  ...
  const { patronName, logout } = useKiosk();
  ...
  return (
    /* Moved mr-4 here and added inline-block to ensure parent matches button width */
    <div className="relative inline-block mr-4" ref={dropdownRef}>
      {/* Main Button */}
      <button 
        onClick={() => setIsOpen(!isOpen)}
        /* Removed mr-4 from here, added w-full */
      ...
      {/* Dropdown Menu - Width is now w-full to match parent */}
      <div 
